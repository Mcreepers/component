...
class com_steer {
   public:
    ...
    void Set_Steer_Offset(uint16_t offset_duty) {
        this->offset_duty = (offset_duty - 15 * duration / 200);
    };
   ...
   private:
    ...
    bool High_Level_or_Low =
        true;  // true is high level 15,false is low level 185
};
