#ifndef __COM_SCREEN_STD_H
#define __COM_SCREEN_STD_H

#define CHN_CHAR_WIDTH 3  // UTF-8:3，GB2312:2

typedef struct {
    char Index[CHN_CHAR_WIDTH + 1];
...
typedef enum {
    ...
    Hardware_SPI = 0x03,
    //	Software_SPI = 0x04
} Screen_hardware;  // Hardware or software IIC
...
namespace font_library {
/*宽6像素，高8像素*/
const unsigned char asc2_0608[][6] = {
...
/*宽8像素，高16像素*/
const unsigned char asc2_0816[][16] = {
...
// 12*12 ASCII字符集点阵
const unsigned char asc2_1212[95][12] = {
...
// 16*16 ASCII字符集点阵
const unsigned char asc2_1616[95][16] = {
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
     0x00, 0x00, 0x00, 0x00}, /*" ",0*/
...
// 24*24 ASICII字符集点阵
const unsigned char asc2_2424[95][36] = {
...
const unsigned char Chinese1616[][16] = {
    ...
    {0x04, 0x04, 0x04, 0x84, 0xE4, 0x3C, 0x27, 0x24, 0x24, 0x24, 0x24, 0xE4,
     0x04, 0x04, 0x04, 0x00},
    {0x04, 0x02, 0x01, 0x00, 0xFF, 0x09, 0x09, 0x09, 0x09, 0x49, 0x89, 0x7F,
     0x00, 0x00, 0x00, 0x00}, /*"有",7*/

    {0x00, 0xFE, 0x22, 0x5A, 0x86, 0x00, 0xFE, 0x92, 0x92, 0x92, 0x92, 0x92,
     0xFE, 0x00, 0x00, 0x00},
    {0x00, 0xFF, 0x04, 0x08, 0x07, 0x00, 0xFF, 0x40, 0x20, 0x03, 0x0C, 0x14,
     0x22, 0x41, 0x40, 0x00}, /*"限",8*/

    {0x00, 0x80, 0x40, 0x20, 0x18, 0x06, 0x80, 0x00, 0x07, 0x18, 0x20, 0x40,
     0x80, 0x00, 0x00, 0x00},
    {0x01, 0x00, 0x20, 0x70, 0x28, 0x26, 0x21, 0x20, 0x20, 0x24, 0x38, 0x60,
     0x00, 0x01, 0x01, 0x00}, /*"公",9*/

    {0x00, 0x10, 0x12, 0x92, 0x92, 0x92, 0x92, 0x92, 0x92, 0x12, 0x12, 0x02,
     0xFE, 0x00, 0x00, 0x00},
    {0x00, 0x00, 0x00, 0x3F, 0x10, 0x10, 0x10, 0x10, 0x3F, 0x00, 0x40, 0x80,
     0x7F, 0x00, 0x00, 0x00}, /*"司",10*/

    {0x10, 0x60, 0x02, 0x8C, 0x00, 0x00, 0xFE, 0x92, 0x92, 0x92, 0x92, 0x92,
     0xFE, 0x00, 0x00, 0x00},
    {0x04, 0x04, 0x7E, 0x01, 0x40, 0x7E, 0x42, 0x42, 0x7E, 0x42, 0x7E, 0x42,
     0x42, 0x7E, 0x40, 0x00}, /*"温",0*/

    {0x10, 0x60, 0x02, 0x8C, 0x00, 0xFE, 0x92, 0x92, 0x92, 0x92, 0x92, 0x92,
     0xFE, 0x00, 0x00, 0x00},
    {0x04, 0x04, 0x7E, 0x01, 0x44, 0x48, 0x50, 0x7F, 0x40, 0x40, 0x7F, 0x50,
     0x48, 0x44, 0x40, 0x00}, /*"湿",1*/

    {0x00, 0x00, 0xFC, 0x24, 0x24, 0x24, 0xFC, 0x25, 0x26, 0x24, 0xFC, 0x24,
     0x24, 0x24, 0x04, 0x00},
    {0x40, 0x30, 0x8F, 0x80, 0x84, 0x4C, 0x55, 0x25, 0x25, 0x25, 0x55, 0x4C,
     0x80, 0x80, 0x80, 0x00}, /*"度",2*/

    {0x80, 0x70, 0x00, 0xFF, 0x10, 0x08, 0xFE, 0x42, 0x42, 0x42, 0xFA, 0x42,
     0x42, 0x42, 0xFE, 0x00},
    {0x80, 0x60, 0x18, 0x07, 0x08, 0x10, 0xFF, 0x50, 0x48, 0x46, 0x41, 0x42,
     0x4C, 0x40, 0xFF, 0x00}, /*"烟",3*/

    {0x10, 0x0C, 0x05, 0x55, 0x55, 0xD5, 0x05, 0x7F, 0x05, 0x55, 0x55, 0x55,
     0x05, 0x14, 0x0C, 0x00},
    {0x10, 0x10, 0x10, 0x8A, 0xA9, 0x6B, 0x35, 0x25, 0x25, 0xAB, 0xE9, 0x08,
     0x10, 0x10, 0x10, 0x00}, /*"雾",4*/

    {0x10, 0x60, 0x02, 0x8C, 0x20, 0x18, 0x08, 0xC8, 0x38, 0xCF, 0x08, 0x08,
     0x28, 0x98, 0x00, 0x00},
    {0x04, 0x04, 0x7E, 0x01, 0x04, 0x02, 0x01, 0xFF, 0x40, 0x21, 0x06, 0x0A,
     0x11, 0x20, 0x40, 0x00}, /*"浓",5*/

    {0x00, 0xF8, 0x01, 0x22, 0xA0, 0xA2, 0xA2, 0x22, 0xFE, 0x22, 0xAA, 0x32,
     0x02, 0xFE, 0x00, 0x00},
    {0x00, 0xFF, 0x00, 0x10, 0x13, 0x0A, 0x4B, 0x20, 0x17, 0x0C, 0x13, 0x38,
     0x80, 0xFF, 0x00, 0x00}, /*"阈",6*/

    {0x00, 0x80, 0x60, 0xF8, 0x07, 0x04, 0xE4, 0xA4, 0xA4, 0xBF, 0xA4, 0xA4,
     0xE4, 0x04, 0x00, 0x00},
    {0x01, 0x00, 0x00, 0xFF, 0x40, 0x40, 0x7F, 0x4A, 0x4A, 0x4A, 0x4A, 0x4A,
     0x7F, 0x40, 0x40, 0x00}, /*"值",7*/

    {0x04, 0x84, 0x84, 0xFC, 0x84, 0x84, 0x00, 0xFE, 0x02, 0x02, 0xF2, 0x02,
     0x02, 0xFE, 0x00, 0x00},
    {0x20, 0x60, 0x20, 0x1F, 0x10, 0x90, 0x40, 0x23, 0x18, 0x06, 0x01, 0x7E,
     0x80, 0x83, 0xE0, 0x00}, /*"现",0*/
    /* (16 X 16 , 宋体 )*/

    {0x08, 0x08, 0x88, 0xC8, 0x38, 0x0C, 0x0B, 0x08, 0x08, 0xE8, 0x08, 0x08,
     0x08, 0x08, 0x08, 0x00},
    {0x02, 0x01, 0x00, 0xFF, 0x40, 0x41, 0x41, 0x41, 0x41, 0x7F, 0x41, 0x41,
     0x41, 0x41, 0x40, 0x00}, /*"在",1*/
    /* (16 X 16 , 宋体 )*/

    {0x00, 0x02, 0x02, 0xF2, 0x12, 0x12, 0x12, 0xF2, 0x02, 0x02, 0x02, 0xFE,
     0x02, 0x02, 0x02, 0x00},
    {0x00, 0x00, 0x00, 0x0F, 0x04, 0x04, 0x04, 0x0F, 0x00, 0x40, 0x80, 0x7F,
     0x00, 0x00, 0x00, 0x00}, /*"可",2*/
    /* (16 X 16 , 宋体 )*/

    {0x00, 0x00, 0xFC, 0x00, 0x00, 0x02, 0x04, 0x18, 0x00, 0x00, 0x80, 0x7F,
     0x00, 0x00, 0x00, 0x00},
    {0x00, 0x00, 0x3F, 0x10, 0x08, 0x84, 0x40, 0x20, 0x10, 0x0C, 0x03, 0x08,
     0x10, 0x20, 0xC0, 0x00}, /*"以",3*/
    /* (16 X 16 , 宋体 )*/

    {0x40, 0x42, 0xCC, 0x00, 0x00, 0xFE, 0x82, 0x92, 0x92, 0xFE, 0x92, 0x92,
     0x82, 0xFE, 0x00, 0x00},
    {0x00, 0x00, 0x3F, 0x10, 0x88, 0x7F, 0x00, 0x1E, 0x12, 0x12, 0x12, 0x5E,
     0x80, 0x7F, 0x00, 0x00}, /*"调",4*/
    /* (16 X 16 , 宋体 )*/

    {0x04, 0x74, 0xD4, 0x54, 0xFF, 0x54, 0xD4, 0x74, 0x14, 0x08, 0x77, 0x84,
     0x44, 0x3C, 0x04, 0x00},
    {0x82, 0x89, 0x88, 0xE8, 0x8B, 0x88, 0x88, 0xF9, 0xA8, 0xAA, 0xA9, 0xA8,
     0xA9, 0x8A, 0x82, 0x00}, /*"整",5*/
    /* (16 X 16 , 宋体 )*/

    {0x10, 0x0C, 0x44, 0x24, 0x14, 0x04, 0x05, 0x06, 0x04, 0x04, 0x14, 0x24,
     0x44, 0x14, 0x0C, 0x00},
    {0x00, 0x40, 0x40, 0x41, 0x41, 0x41, 0x41, 0x7F, 0x41, 0x41, 0x41, 0x41,
     0x40, 0x40, 0x00, 0x00}, /*"空",6*/
    /* (16 X 16 , 宋体 )*/

    {0x20, 0x10, 0x4C, 0x47, 0x54, 0x54, 0x54, 0x54, 0x54, 0x54, 0x54, 0xD4,
     0x04, 0x04, 0x00, 0x00},
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0F,
     0x30, 0x40, 0xF0, 0x00}, /*"气",7*/
    /* (16 X 16 , 宋体 )*/

    {0x00, 0x00, 0xFE, 0x12, 0x12, 0x92, 0x92, 0x92, 0x92, 0xFF, 0x91, 0x91,
     0x91, 0x91, 0x10, 0x00},
    {0x80, 0x60, 0x1F, 0x80, 0x80, 0x5F, 0x40, 0x20, 0x10, 0x0E, 0x10, 0x10,
     0x20, 0x5F, 0x80, 0x00}, /*"质",8*/
    /* (16 X 16 , 宋体 )*/

    {0x20, 0x20, 0x20, 0xBE, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xBE,
     0x20, 0x20, 0x20, 0x00},
    {0x00, 0x80, 0x80, 0xAF, 0xAA, 0xAA, 0xAA, 0xFF, 0xAA, 0xAA, 0xAA, 0xAF,
     0x80, 0x80, 0x00, 0x00}, /*"量",9*/
    /* (16 X 16 , 宋体 )*/

    {0x00, 0x80, 0x60, 0xF8, 0x07, 0x10, 0x10, 0x10, 0xFF, 0x10, 0xF0, 0x11,
     0x16, 0x10, 0x10, 0x00},
    {0x01, 0x00, 0x00, 0xFF, 0x00, 0x80, 0x60, 0x1C, 0x03, 0x00, 0x3F, 0x40,
     0x40, 0x40, 0x78, 0x00}, /*"优",10*/
    /* (16 X 16 , 宋体 )*/

    {0x00, 0x00, 0xFC, 0x24, 0x24, 0x24, 0x25, 0x26, 0x24, 0x24, 0x24, 0xFC,
     0x00, 0x00, 0x00, 0x00},
    {0x00, 0x00, 0xFF, 0x81, 0x41, 0x21, 0x03, 0x05, 0x09, 0x11, 0x29, 0x45,
     0x42, 0x80, 0x80, 0x00}, /*"良",11*/
    /* (16 X 16 , 宋体 )*/

    {0x00, 0x04, 0x24, 0x24, 0x25, 0x26, 0xE4, 0x3C, 0x24, 0x26, 0x25, 0x24,
     0x24, 0x04, 0x00, 0x00},
    {0x41, 0x21, 0x11, 0x89, 0x85, 0x8B, 0x89, 0x89, 0xF9, 0x89, 0x89, 0x89,
     0x89, 0x81, 0x01, 0x00}, /*"差",12*/
    /* (16 X 16 , 宋体 )*/
