...
// disable because htim must define before com_time
//  com_time::com_time(volatile uint32_t *us_tick_ptr, uint16_t period)
//  {
//  	this->tick_ptr = us_tick_ptr;
...
uint64_t com_time::get_time_us_count(void) { return tick_count; }
...
unsigned int com_get_tick(void) { return HAL_GetTick(); }
...
uint8_t com_time::delay_ms_os(uint32_t ms) { return osDelay(ms); }
#endif
